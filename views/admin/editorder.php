        ...
        <form action="/shop/controllers/OrderController.php?action=saveEditOrder" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="delivery_address"
                    name="delivery_address"><?php echo $order['Delivery_address']; ?></textarea>
            </div>

            <div class="form-group">
                <label for="date_created">Date Created:</label>
                <input type="text" class="form-control" id="date_created" name="date_created"
                    value="<?php echo $order['Date_created']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="date_updated">Date Updated:</label>
                <input type="text" class="form-control" id="date_updated" name="date_updated"
                    value="<?php echo $order['Date_updated']; ?>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="is_pay_onl" name="is_pay_onl">
