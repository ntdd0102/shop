...
<body>
    <div class="container">
        ...
        <?php if ($product) : ?>
            <form action="/shop/controllers/ProductController.php?action=saveEditProduct" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="product_id" value="<?php echo $product['Id']; ?>">

                <div class="form-group">
                    <label for="name">Name:</label>
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $product['Name']; ?>" readonly>
                </div>
