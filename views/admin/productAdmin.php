                        ...
                        <tbody>
                            <?php foreach ($displayProducts as $product) : ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo $product['Image']; ?>" alt="<?php echo $product['Name']; ?>" class="product-image img-thumbnail"></td>
                                    <td style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo $product['Description']; ?>"><?php echo $product['Description']; ?>
                                    </td>
