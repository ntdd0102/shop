                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Order Actions">
                                                <a href="/shop/controllers/OrderController.php?action=editOrder&id=<?php echo $order['Id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                                <a href="/shop/controllers/OrderController.php?action=cancelOrder&id=<?php echo $order['Id']; ?>" class="btn btn-danger btn-sm">Cancel</a>
                                                <a href="/shop/controllers/OrderController.php?action=viewOrderDetail&id=<?php echo $order['Id']; ?>" class="btn btn-info btn-sm">View Details</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
