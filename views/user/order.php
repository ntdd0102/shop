            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 text-end">
                    <?php if ($paymentMethod === 'cash') { ?>
                        <a href="/shop/controllers/PaymentController.php?action=getInforOrder&order=cash" class="btn btn-primary">Thanh toán</a>
                    <?php } elseif ($paymentMethod === 'online') { ?>
                        <a href="/shop/controllers/PaymentController.php?action=getInforOrder&order=onl" class="btn btn-primary">Thanh toán</a>
                    <?php } ?>
                </div>
            </div>
