...
<body>
    ...
    <div id="resultMessage" class="alert alert-success" role="alert">
        <?php echo $_SESSION['cancelResult']; ?>
    </div>
    <script>
    setTimeout(function() {
    ...
    <div class="container mt-4">
        ...
        <form class="form-inline my-2 my-lg-0" method="POST"
            action="/shop/controllers/OrderController.php?action=searchByOrderName">
            <input class="form-control mr-sm-2" type="search" placeholder="Tìm kiếm" aria-label="Search"
                name="orderName">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Tìm kiếm</button>
        </form>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form method="POST"
                    action="/shop/controllers/OrderController.php?action=cancelOrder&id=<?php echo $order['Id']; ?>">
                    <input type="hidden" name="orderId" value="<?php echo $order['Id']; ?>">
                    <input type="hidden" name="orderName" value="<?php echo $order['Name']; ?>">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($product) : ?>
                                    <img src="<?php echo $product['Image']; ?>" alt="Hình ảnh sản phẩm"
