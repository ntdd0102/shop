 ...
 <body>
     ...
     <div class="container mt-4">
         <?php foreach ($productsByCategory as $categoryId => $products) : ?>
             ...
             <h4 class="my-4 display-4 font-weight-bold text-dark" style="font-size: 20px; color: #333; font-family: 'Arial', sans-serif; margin-bottom: 10px;">
                 <?php echo $categoryModel->getCategoryNameById($categoryId); ?>
             </h4>
             ...
             <div class="row">
                 ...
                 <?php if (count($products) > 4) : ?>
                     <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                         <div class="card h-100 product-card">
                             <a href="/shop/views/user/product_list.php?category_id=<?php echo $categoryId; ?>" class="card-link">
